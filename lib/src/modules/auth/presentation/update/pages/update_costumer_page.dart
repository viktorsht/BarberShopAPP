...
class UpdateCostumerPage extends StatefulWidget {
  ...
  @override
  State<UpdateCostumerPage> createState() => _UpdateCostumerPageState();
}

class _UpdateCostumerPageState extends State<UpdateCostumerPage> {
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Scaffold(
        appBar: const AppBarWidget(title: 'Meu Perfil'),
