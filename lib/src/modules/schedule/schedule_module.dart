...
import 'package:client_barber_shop/src/modules/schedule/presentation/pages/calendar_page.dart';
...
class ScheduleModule extends Module{
  ...
  void routes(RouteManager r) {
    ...
    r.child(AppRoutes.schedule, child: (context) => CalendarPage(controller: Modular.get(),));
  }
